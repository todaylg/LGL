...
export class Renderer {
	...
	/**
	 * Clear buffer
	 * @param {Object} color - render target
	 * @param {Object} depth - render target
	 * @param {Object} stencil - render target
	 */
	 ...
	 */
	render({ scene, camera, target = null, update = true, sort = true, frustumCull = true, clear = null }) {
		if (target === null) {
